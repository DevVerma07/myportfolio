            ...
            Ce(
                (function(t) {
                    ...
                    return (
                        ...
                        (a += Vt(i.clientWidth, s ? s.clientWidth : 0) - o), { width: o, height: r, x: a, y: l }
                    );
                })(ee(t))
            );
    }
        ...
        _getPopperConfig() {
            ...
            return (
                ...
                (H.setDataAttribute(this._menu, "popper", "static"),
                    (t.modifiers = [{ name: "applyStyles", enabled: !1 }])), {...t, ...p(this._config.popperConfig, [t]) }
            );
        }
